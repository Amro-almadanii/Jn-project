...
// console.log(socialmediaExpectedRevenues)
// console.log(campaignDetail[0].socialmedia_Revenue[0].socialmedia_Revenue[0].socialmedia_expected_revenue)
// console.log(socialmediaExpectedRevenues)
// console.log(eventExpectedRevenues)
console.log(campaignDetail)
return(<>
    <Card className={classes.containar}>
    { chartExpectedRevenue != undefined && chartActualRevenue!= undefined }
...
<h1>Revenue </h1>
<div className={classes.childrenCard}>
<Card className={classes.cards}><h4>Event Expected</h4><div className={classes.countUp} >
    <CountUp end={x[2]} start={0} duration={3} />$</div></Card>
<Card className={classes.cards}><h4>Event Actual</h4><div className={classes.countUp}> <CountUp end={x[3]} start={0} duration={3} />$</div></Card>
<Card className={classes.cards}><h4>Socialmedia Expected</h4> <div className={classes.countUp}><CountUp end={x[0]} start={0} duration={3} />$</div></Card>
<Card className={classes.cards}><h4>Socialmedia Actual</h4><div className={classes.countUp}> <CountUp end={x[1]} start={0} duration={3} />$</div></Card>
<Card className={classes.cards}><h4>Tv Expected</h4><div className={classes.countUp} ><CountUp end={x[4]} start={0} duration={3} />$</div></Card>
<Card className={classes.cards}><h4>Tv Actual</h4><div className={classes.countUp}> <CountUp end={x[5]} start={0} duration={3} />$</div></Card>
</div>
</Card>
</>
)
